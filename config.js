...
global.readmessagefrom = process.env.READ_MESSAGE_FROM || "null,94761167172";


//========================= [ AUTO SAVE & READ STATUS ] =========================\\
global.read_status = process.env.AUTO_READ_STATUS || "false"
global.save_status = process.env.AUTO_SAVE_STATUS || "false"
global.save_status_from =  process.env.SAVE_STATUS_FROM  || "null,94761167172";
global.read_status_from =  process.env.READ_STATUS_FROM  ||  "94761167172";
...
module.exports = {
  ...
  menu: process.env.MENU || "", /**  Available @MENU @Schemes 1: Aztec_Md, 2: A17_Md, 3: ؄͜͡亗『ＳＨＡＬＩ』亗 Default ---------- If Not Choose then it Randomely Pic One Of Them Each time **/
  ...
  botname : process.env.BOT_NAME  || "؄͜͡亗『ＳＨＡＬＩ』亗-ᴍᴅ",
  ownername:process.env.OWNER_NAME|| "SHALINDA",


  errorChat : process.env.ERROR_CHAT || "",
  KOYEB_API : process.env.KOYEB_API  || "false",

  REMOVE_BG_KEY : process.env.REMOVE_BG_KEY  || "ツＳＨＡＬＩＹＡ๛",
  OPENAI_API_KEY: process.env.OPENAI_API_KEY || "ツＳＨＡＬＩＹＡ๛",
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || "ツＳＨＡＬＩＹＡ๛",
  HEROKU_APP_NAME:process.env.HEROKU_APP_NAME|| "ツＳＨＡＬＩＹＡ๛",
